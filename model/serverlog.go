...
type ServerLog struct {
	...
	RequestTime        time.Time `json:"request_time" gorm:"column:request_time;type:timestamptz"`
	...
	ResponseTime       time.Time `json:"response_time" gorm:"column:response_time;type:timestamptz"`
